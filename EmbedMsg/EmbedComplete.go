...
func main() {
	...
	skList1, err := msk1.DeprivCntKeys(client, 0, 8, netType)
	if err != nil {
		log.Fatal(err)
	}
...
func SendLeakTrans(client *rpcclient.Client, msk *Key.PrivateKey, kLeak *string) (*chainhash.Hash, error) {
